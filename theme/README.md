...
| `snippets/header-row.liquid` | Файл темы. Переключатель Shop: Women/Men перенесён в левую колонку верхнего ряда — по макету он стоит на одной строке с вордмарком. |
